...
- (void)getNoti:(NSNotification *) notiSender {
    NSLog(@"SettingView Notification call");
    NSLog(@"SettingView object: %@", notiSender.object);
    NSLog(@"SettingView dictionary: %@", notiSender.userInfo);
