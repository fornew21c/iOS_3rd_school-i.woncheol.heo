...
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"notiKey" object:@"notification test" userInfo:{@"ID":[NSUserDefaults standardUserDefaults] objectForKey:@"ID", @"PW": [NSUserDefaults standardUserDefaults] objectForKey:@"PW"}];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"notiKey" object:@"notification test" userInfo:@{@"ID":@"1234"}];
