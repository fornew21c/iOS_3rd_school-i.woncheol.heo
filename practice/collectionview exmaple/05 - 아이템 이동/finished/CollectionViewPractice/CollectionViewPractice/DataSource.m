...
- (void)deleteItemAtIndexPaths:(NSArray< NSIndexPath *> *)indexPaths {
    ...
    for (NSIndexPath *indexPath in indexPaths) {
        ...
        [indexSets addIndex:indexPath.item];
    }
    
    [self.parkDataArray removeObjectsAtIndexes:indexSets];
}
...
- (void)moveItemAtIndexPath:(NSIndexPath *)sourceIndexPath destinationIndexPath:(NSIndexPath *)destinationIndexPath {
    ...
    ParkData *sourceData = [self.parkDataArray objectAtIndex:sourceIndexPath.item];
    [self.parkDataArray removeObjectAtIndex:sourceIndexPath.item];
    [self.parkDataArray insertObject:sourceData atIndex:destinationIndexPath.item];
}
